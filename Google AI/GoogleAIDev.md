...
2. 
3. [Arquitectura Fundamental del ADK](#2-arquitectura-fundamental-del-adk)
4. [Instalación y Configuración Inicial](#3-instalación-y-configuración-inicial)
5. [Tu Primer Agente — Paso a Paso](#4-tu-primer-agente--paso-a-paso)
6. [Tipos de Agentes en ADK](#5-tipos-de-agentes-en-adk)
7. [Tools (Herramientas) — El Poder de los Agentes](#6-tools-herramientas--el-poder-de-los-agentes)
8. [Callbacks y Guardrails — Control y Seguridad](#7-callbacks-y-guardrails--control-y-seguridad)
9. [Sessions, State y Memory — Persistencia Inteligente](#8-sessions-state-y-memory--persistencia-inteligente)
10. [Sistemas Multi-Agente con ADK](#9-sistemas-multi-agente-con-adk)
11. [ADK y RAG — Aclarando la Confusión](#10-adk-y-rag--aclarando-la-confusión)
12. [Integración con Protocolos: MCP y A2A](#11-integración-con-protocolos-mcp-y-a2a)
13. [Testing y Evaluación de Agentes](#12-testing-y-evaluación-de-agentes)
14. [Deployment — De Local a Producción](#13-deployment--de-local-a-producción)
15. [Patrones de Diseño y Mejores Prácticas](#14-patrones-de-diseño-y-mejores-prácticas)
16. [Referencia Rápida de Comandos CLI](#15-referencia-rápida-de-comandos-cli)
